...
<link href="css/company.css" rel="stylesheet" type="text/css" media="screen" />
<!-- InstanceEndEditable -->
...
<!-- InstanceEndEditable -->
<!-- InstanceParam name="id" type="text" value="campany_page" -->
</head>

<body id="campany_page" onload="MM_preloadImages('images/cart_b_ov.gif','images/new_uesr_b_ov.gif','images/c_image1ov.jpg','images/c_image2ov.jpg','images/c_image3ov.jpg','images/c_image4ov.jpg',,'images/image_1ov.jpg','images/image_2ov.jpg','images/image_3ov.jpg')">
<!--Container開始-->
<div id="container">
<!--Header開始-->
<div id="header">
...
<div id="contents">
  ...
  <table>
    <tr>
      <th scope="row">社名</th>
      <td>ビーンズライフコーヒー&nbsp;BeansLifeCoffee</td>
    </tr>
    <tr>
      <th scope="row">創業</th>
      <td>2010月02月10日</td>
    ...
    <tr>
      ...
      <td>大阪府大阪市北区中津3丁目6-28</td>
    </tr>
    <tr>
      <th scope="row">事業内容</th>
      <td>コーヒー豆のネット販売及びカフェ経営</td>
    </tr>
    <tr>
      <th scope="row">代表者</th>
      <td>鈴木太郎</td>
