...
if(isset($_SESSION[item]) && $_SESSION['time_g']+10 > time()){
	...
	if($_POST['goods']=="マンデリン" && $_POST['bean']=="0"){
		$error['mandL'] = 'blank';
	}elseif($_POST['goods']=="コロンビア" && $_POST['bean']=="0"){
		$error['coluB'] = 'blank';
	}elseif($_POST['goods']=="ハワイコナ" && $_POST['bean']=="0"){
    	$error['hawaiK'] = 'blank';
    }
    
	//豆の状態を選んで「カートに入れる」を選択した場合
    if($_POST['goods']=="マンデリン" && $_POST['bean'] != "0"){
    	$image="images/mandh_mini.gif";
    ...
    if($_POST['goods']=="コロンビア" && $_POST['bean'] != "0"){
    	$image="images/Colum_mini.gif";
    	$goodsName=$_POST['goods'];
    	$bean=$_POST['bean'];
        $qnt=$_POST['qnt'];
        $price=$_POST['price']*$_POST['qnt'];
    ...
    if($_POST['goods']=="ハワイコナ" && $_POST['bean'] != "0"){
    	$image="images/hawakona_mini.gif";
    	$goodsName=$_POST['goods'];
    	$bean=$_POST['bean'];
        $qnt=$_POST['qnt'];
        $price=$_POST['price']*$_POST['qnt'];
...
<div id="contents">
  ...
  <div id="gNavi">
  <ul>
    <li><a href="goods_2.php" id="gs">ストレートコーヒー</a></li>
...
<div id="gBack">
    <div id="gBack_a">
      <div class="gWpr">
        <p class="gImage"><img src="images/mandh.gif" width="156" height="195" alt="マンデリン" /></p>
        <div class="tText">
          <p class="gTitle">マンデリン</p>
          <p class="gText">強い苦みと芳ばしい香りが<br />
            特徴的で、大人の味です。</p>
          </div>
        <div class="pQuant">
          ...
          <form action="" method="post" name="select_1" id="select_1">
            ...
            <p class="btn">
            	...
            	<input name="goods" type="hidden" id="goods" value="マンデリン" />
      ...
      <div class="gWpr">
        <p class="gImage"><img src="images/Colum.gif" width="156" height="195" alt="コロンビア" /></p>
        <div class="tText">
          <p class="gTitle">コロンビア</p>
          <p class="gText">程よい苦みと酸味、後から<br />
            くる甘い香りで、癖のない<br />
            味に仕上がっています。</p>
          </div>
        <div class="pQuant">
          ...
          <form action="" method="post" name="select_1" id="select_1">
            ...
            <p class="btn">
            	<input name="cartIn" type="image" id="cartIn" src="images/cartImage2.gif" alt="カートに入れる" />
            	<input name="goods" type="hidden" id="goods" value="コロンビア" />
      ...
      <div class="gWpr">
        <p class="gImage"><img src="images/hawakona.gif" width="156" height="195" alt="ハワイコナ" /></p>
        <div class="tText">
          <p class="gTitle">ハワイコナ</p>
        ...
        <div class="pQuant">
          ...
          <form action="" method="post" name="select_1" id="select_1">
            ...
            <p class="btn">
            	<input name="cartIn" type="image" id="cartIn" src="images/cartImage2.gif" alt="カートに入れる" />
            	<input name="goods" type="hidden" id="goods" value="ハワイコナ" />
           ...
           <p class="gPage"><a href="goods.php">前のページ</a>&nbsp;|&nbsp;<!--
        	--><a href="goods.php">1</a>&nbsp;|&nbsp;<!--
            -->2&nbsp;|&nbsp;<!--
            --><a href="goods_3.php">3</a>&nbsp;|&nbsp;<!--
            --><a href="goods_3.php">次のページ</a></p>
      </div>
</div>
</div><!--Contents終了-->
