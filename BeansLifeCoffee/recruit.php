...
<div id="contents">
  <div id="gBack">
  <h3>採用情報&nbsp;RECRUIT</h3>
  <p>アルバイト&nbsp;BeansLifeCafe本店スタッフ</p>
  <table>
    <tr>
      <th scope="row">仕事内容</th>
      <td>接客サービス及び簡単な調理業務をお願いします。</td>
      </tr>
    <tr>
      <th scope="row">勤務場所</th>
      <td>BeansLifeCafe本店(中津駅&nbsp;徒歩10分)</td>
      </tr>
    <tr>
    ...
    <tr>
      <th class="tb" scope="row">応募方法</th>
      <td class="tb">(02-654-789)に連絡後<br />
        面接の上、採用通知をさせて頂きます。</td>
      </tr>
  </table>
  <p>アルバイト&nbsp;BeansLifeCoffeeネット販売スタッフ</p>
    <table>
    <tr>
      <th scope="row">仕事内容</th>
      <td>商品の梱包/データ管理</td>
    ...
    <tr>
      <th scope="row">応募資格</th>
      <td>高卒以上<br />
        Word/Excel/Powerpointの簡単な操作ができる方</td>
      </tr>
    <tr>
      <th class="tb" scope="row">応募方法</th>
      <td class="tb">(02-654-789)に連絡後<br />
