...
if($_POST['btn01']=="1"){
	...
	if($_POST['goods']=="ブルーマウンテン" && $_POST['bean']=="0"){
		$error['blueM'] = 'blank';
	}elseif($_POST['goods']=="モカ" && $_POST['bean']=="0"){
		$error['moka'] = 'blank';
	}elseif($_POST['goods']=="キリマンジャロ" && $_POST['bean']=="0"){
    	$error['kiriM'] = 'blank';
    }
    /*--testStart--
    if($_POST['goods']=='ブルーマウンテン' && $_POST['bean'] != '0'){
    ...
    if($_POST['goods']=="モカ" && $_POST['bean'] != "0"){
    	$image="images/moka_mini.gif";
    	$goodsName=$_POST['goods'];
    	$bean=$_POST['bean'];
        $qnt=$_POST['qnt'];
        $price=$_POST['price']*$_POST['qnt'];
    ...
    if($_POST['goods']=="キリマンジャロ" && $_POST['bean'] != "0"){
    	$image="images/kiliman_mini.gif";
    	$goodsName=$_POST['goods'];
    	$bean=$_POST['bean'];
        $qnt=$_POST['qnt'];
        $price=$_POST['price']*$_POST['qnt'];
...
<link href="css/goods.css" rel="stylesheet" type="text/css" media="screen" />
<link href="css/goods_tab.css" rel="stylesheet" type="text/css" media="screen" />
<!-- InstanceEndEditable -->
...
<div class="header_t">
	...
	<ul>
		<li class="subnavi_1"><a href="http://connect-ki.noor.jp/BeansLifeCoffee/guide.php">配達・送料</a></li>
		<li><a href="http://connect-ki.noor.jp/BeansLifeCoffee/sitemap.php">サイトマップ</a></li>
		<li><a href="http://connect-ki.noor.jp/BeansLifeCoffee/recruit.php">採用情報</a></li>
	</ul>
</div>
<!--Header終了-->
</div>
...
<div id="g_navi">
	<ul>
		<li><a href="http://connect-ki.noor.jp/BeansLifeCoffee/index.php" id="home">ホーム</a></li>
		<li><a href="http://connect-ki.noor.jp/BeansLifeCoffee/goods.php" id="goods">商品一覧</a></li>
		<li><a href="http://connect-ki.noor.jp/BeansLifeCoffee/store_d.php" id="store">店舗メニュー</a></li>
		<li><a href="http://connect-ki.noor.jp/BeansLifeCoffee/howtoinfo.php" id="howtoinfo">ご購入ガイド</a></li>
    	<li><a href="https://noor-connect-ki.ssl-lolipop.jp/BeansLifeCoffee/sitework/inquiry.php" id="inquiry">お問合わせ</a></li>
    	<li><a href="http://connect-ki.noor.jp/BeansLifeCoffee/access.php" id="access">アクセス</a></li>
	</ul>
</div>
<!--GlobalNavi終了-->
<!--SideMenu開始-->
	...
	<div id="side_info">
		<div id="s_cart">
			<div id="s_info">
				...
				<p class="c_info"><a href="http://connect-ki.noor.jp/BeansLifeCoffee/cartinfo.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('cart_image','','images/cart_b_ov.gif',1)">
		...
		<div id="u_login">
			...
			<?php if($_SESSION['login'] == ""): ?>
           		<form id="login_f" name="login_f" method="post" action="">
              		...
              		<p class="pass_i"><a href="http://connect-ki.noor.jp/BeansLifeCoffee/r_line.php">パスワードをお忘れの方</a></p>
              		<p class="new_u">
...
<div id="contents">
	...
	<div id="gBack">
        <div class="gWpr">
          <p class="gImage"><img src="images/blumoun.gif" width="156" height="195" alt="ブルーマウンテン" /></p>
          <div class="tText">
            <p class="gTitle">ブルーマウンテン</p>
            <p class="gText"> 味・香り・コクのすべてが<br />
              バランス良く、根強く支持<br />
              されているコーヒーです。</p>
          </div>
          <div class="pQuant">
            <p class="gPrice">100g&nbsp;\1,800&nbsp;(税込)</p>
            <form id="select_1" name="select_1" method="post" action="" >
              <dl>
              ...
              <p class="btn">
              	...
              	<input name="goods" type="hidden" id="goods" value="ブルーマウンテン" />
              	<input name="price" type="hidden" id="price" value="1800" />
        ...
        <div class="gWpr">
          <p class="gImage"><img src="images/moka.gif" width="156" height="195" alt="モカ" /></p>
          <div class="tText">
            <p class="gTitle">モカ</p>
            <p class="gText">強い酸味とほのかな甘みが<br />
              日本人の舌によく合います。</p>
          </div>
          <div class="pQuant">
            <p class="gPrice">100g&nbsp;\560&nbsp;(税込)</p>
            <form action="" method="post" name="select_1" id="select_1">
              ...
              <p class="btn">
              	<input name="cartIn" type="image" id="cartIn" src="images/cartImage2.gif" alt="カートに入れる" />
              	<input name="goods" type="hidden" id="goods" value="モカ" />
              	<input name="price" type="hidden" id="price" value="560" />
                <input name="btn01" type="hidden" id="btn01" value="1" />
              </p>
            </form>
          </div>
        ...
        <div class="gWpr">
          <p class="gImage"><img src="images/kiliman.gif" width="156" height="195" alt="キリマンジャロ" /></p>
          <div class="tText">
            <p class="gTitle">キリマンジャロ</p>
            <p class="gText">さっぱりとした苦み<br />
              独特で強い酸味と甘い香りを<br />
              お楽しみください。</p>
          </div>
          <div class="pQuant">
            <p class="gPrice">100g&nbsp;\600&nbsp;(税込)</p>
            <form action="" method="post" name="select_1" id="select_1">
              <dl>
                <dt class="Bean">豆の状態</dt>
                <dd>
			  ...
			  <?php if($error['kiriM']=='blank'): ?>
              	<p class="be">*豆の状態を選んでください</p>
              <?php endif; ?>
              <dl>
                <dt class="Quant">数量</dt>
                <dd>
              ...
              <p class="btn">
              	<input name="cartIn" type="image" id="cartIn" src="images/cartImage2.gif" alt="カートに入れる" />
              	<input name="goods" type="hidden" id="goods" value="キリマンジャロ" />
        ...
        <p class="gPage"><!--
        	-->1&nbsp;|&nbsp;<!--
        	--><a href="goods_2.php">2</a>&nbsp;|&nbsp;<!--
            --><a href="goods_3.php">3</a>&nbsp;|&nbsp;<!--
            --><a href="goods_2.php">次のページ</a></p>
    </div>
</div>
<!--Contents終了-->
...
<div id="footer">
	<ul>
		<li class="subnavi_2"><a href="http://connect-ki.noor.jp/BeansLifeCoffee/p_policy.php">プライバシーポリシー</a></li>
		<li><a href="http://connect-ki.noor.jp/BeansLifeCoffee/company.php">会社概要</a></li>
	</ul>
