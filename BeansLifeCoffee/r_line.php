...
<link href="css/r_line.css" rel="stylesheet" type="text/css" media="screen" />
<!-- InstanceEndEditable -->
...
<div id="contents">
  <div id="gBack">
  <h3 class="md">パスワードをお忘れの方へ</h3>
    <p class="tx">下記のフォームにメールアドレスをご記入の上、送信ボタンを押してください。</p>
    <form id="mailform" name="mailform" method="post" action="r_line_complete.php">
  		<p class="mi">
  		  <label><span>*</span>メールアドレスを入力してください&nbsp;<!--
       --><input name="mail" type="text" size="45" /></label>
        </p>
        <p class="sb"><input type="image" name="soushin" id="soushin" src="images/soushin.gif" /></p>
    </form>
  </div>
</div>
<!--Contents終了-->
