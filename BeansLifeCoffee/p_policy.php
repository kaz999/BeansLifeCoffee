...
<div id="contents">
  <div id="gBack">
  	<h3>プライバシーポリシー&nbsp;PrivacyPolicy</h3>
    	<h4>個人情報の定義</h4>
    		<p>個人情報とは、個人に関する情報であり、氏名、住所、電話番号<br />
            電子メールアドレス、生年月日、性別等の個人を識別できる情報をいいます。</p>
    	<h4>個人情報の利用について</h4>
	  		<p class="pt">お客様からお預かりした個人情報の利用目的は以下の通りです。</p>
    		<p class="pli">1)コーヒー豆のネットショッピングサイト<br />
              <span>「BeansLifeCoffeeビーンズライフコーヒー」でのご注文の確認・決済</span></p>
    		<p class="pli">2)商品発送の確認・手続き</p>
	  		<p class="pb_1">3)各種お問い合わせ時の確認・返信</p>
    	<h4>個人情報の第三者提供について</h4>
	  		<p class="pt">お客様からお預かりした個人情報は、以下の場合を除き<br />
   		    	第三者に提供することはありません。</p>
    		<p class="pli">1)商品発送の手続き</p>
    		<p class="pli">2)法令違反や利用規約違反に基づく正当な理由</p>
   		<h4>個人情報の管理について</h4>
    		<p>法令に準じた適切な取り扱いをし、個人データの不正、改ざん、紛失<br />
   		    漏えいを防ぐとともに、常にデータの安全管理を怠らないよう努めます。</p>
    	<h4>セキュリティについて</h4>
    		<p class="pb_2">個人情報の保護の為、お客様の情報入力時には第三者の妨害、傍受<br />
