...
//MYSQL内に書き込み
$sql="INSERT INTO  inquiry(SEI,MEI,SEIKANA,MEIKANA,ZIPCODE1,ZIPCODE2,JYUSHO,TEL,MAIL,COMMENT)".
	 "VALUES('$sei','$mei','$seikana','$meikana','$zipcode1','$zipcode2','$jyusho','$tel','$mail','$comment')";
...
<div id="contents">
  ...
  <h4>お問合せ完了</h4>
    <p class="tx2"><!--
	 	-->お問合せ内容を送信しました。<!--
	 	--><br />この度は、お問い合わせありがとうございました。<!--
	 	--><br />返信内容によっては時間を要しますので、ご了承ください。
    </p>
    <p class="btn_1"><a href="index.php">トップページへ戻る</a></p>
  </div>
</div>
<!--Contents終了-->
