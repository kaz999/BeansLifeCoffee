...
<div id="contents">
  <div id="gBack">
    <h3>サイトマップ&nbsp;SITEMAP</h3>
    	<h4>商品一覧&nbsp;GoodsList</h4>
	  		<p class="pt"><a href="goods.php">ストレートコーヒー&nbsp;StraightCoffee</a></p>
     		<p class="pb"><a href="goods_b.php">ブレンドコーヒー&nbsp;BlendCoffee</a></p>
        <h4>店舗メニューMenu</h4>
	  <p class="pt"><a href="store_d.php">ドリンク&nbsp;Drink</a></p>
	  <p class="pb"><a href="store_f.php">軽食&nbsp;Meal</a></p>
    		<p><a href="howtoinfo.php">ご購入ガイド&nbsp;ShoppingGuide</a></p>
	  		<p><a href="inquiry.php">お問合せ&nbsp;Inquery</a></p>
	  		<p><a href="access.php">アクセス&nbsp;Access</a></p>
    		<p><a href="guide.php">配送・送料&nbsp;Shipping&nbsp;and&nbsp;Delivery</a></p>
    		<p><a href="recruit.php">採用情報&nbsp;Recruit</a></p>
    		<p><a href="p_policy.php">プライバシーポリシー&nbsp;PrivacyPolicy</a></p>
    		<p><a href="company.php">会社概要&nbsp;Company</a></p>
    		<p><a href="newuser.php">新規登録&nbsp;NewUser	 		</a></p>
    		<p class="sb"><a href="r_line.php">ログインパスワードをお忘れの方へ</a></p>
  </div>
</div>
<!--Contents終了-->
