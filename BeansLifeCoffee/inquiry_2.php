...
<h3><img src="images/inquiryM.gif" width="610" height="200" alt="お問い合わせINQUERY" /></h3>
  <div id="gBack">
  <h4>確認画面</h4>
  <p class="tx">この内容でお間違えなければ、送信ボタンを押してください。</p>
  <form id="inquiry_form" name="inquiry_form" method="post" action="inquiry_complete.php?<?php echo SID; ?>">
    <table>
      <tr>
        <th scope="row">お名前</th>
      ...
      <div class="btnArea">
  		<p><a href="inquiry.php?input=1<?php echo SID; ?>"><img src="images/modoru2.gif" width="130" height="30" alt="戻る" /></a></p>
      	<p><input type="image" name="submit" id="submit" src="images/soushin.gif" /></p>
      </div>
  </form>
  </div>
</div>
