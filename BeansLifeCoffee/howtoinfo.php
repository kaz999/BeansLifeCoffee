...
<link href="css/howtoinfo.css" rel="stylesheet" type="text/css" media="screen" />
<!-- InstanceEndEditable -->
<!-- InstanceParam name="id" type="text" value="howtoinfo_page" -->
</head>

<body id="howtoinfo_page" onload="MM_preloadImages('images/cart_b_ov.gif','images/new_uesr_b_ov.gif','images/c_image1ov.jpg','images/c_image2ov.jpg','images/c_image3ov.jpg','images/c_image4ov.jpg',,'images/image_1ov.jpg','images/image_2ov.jpg','images/image_3ov.jpg')">
<!--Container開始-->
<div id="container">
<!--Header開始-->
<div id="header">
...
<!--Contents開始-->
<div id="contents">
  <h3><img src="images/shoppingGuide.gif" width="610" height="200" alt="ご購入ガイドShoppingGuide" /></h3>
  <div id="gBack">
  <p class="g_img"><img src="images/guide.jpg" width="500" height="700" alt="ガイドイメージ" /></p>
    <h4>お支払について</h4>
    <ul class="pay_h">
      <li>クレジットカード決済</li>
      <li>銀行振り込み<br />
        <span>振込先&nbsp;三菱東京UFJ銀行&nbsp;松戸支店&nbsp;普通&nbsp;1234560</span><br />
        <span>※振込手数料はお客様負担になりますので、ご了承下さい。</span></li>
      <li>代金引換<br />
        <span>代引手数料:\350</span></li>
    </ul>
  </div>
</div>
<!--Contents終了-->
