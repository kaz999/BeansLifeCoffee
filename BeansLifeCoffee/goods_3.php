...
//豆の状態を選んでいない場合、エラー文を生成
	if($_POST['goods']=="グアテマラ" && $_POST['bean']=="0"){
		$error['guatM'] = 'blank';
	}

//豆の状態を選んで「カートに入れる」を選択した場合
    if($_POST['goods']=="グアテマラ" && $_POST['bean'] != "0"){
    	$image="images/guate_mini.gif";
...
<div id="contents">
  ...
  <div id="gNavi">
  	<ul>
    	<li><a href="goods_3.php" id="gs">ストレートコーヒー</a></li>
  ...
  <div id="gBack_a">
  	  <div class="gWpr">
  	    <p class="gImage"><img src="images/guate.gif" width="156" height="195" alt="グアテマラ" /></p>
        <div class="tText">
			<p class="gTitle">グアテマラ</p>
			<p class="gText">
            	酸味が強く、苦味がほど良く<br />
		    	広がります。フルーティーな<br />
		    	香りと甘味が特徴的です。
        ...
        <div class="pQuant">
          ...
          <p class="btn">
          	...
          	<input name="goods" type="hidden" id="goods" value="グアテマラ" />
            <input name="price" type="hidden" id="price" value="580" />
            <input name="btn01" type="hidden" id="btn01" value="1" />
          </p>
          </form>
        </div>
  	  </div>
        <p class="gPage"><a href="goods_2.php">前のページ</a>&nbsp;|&nbsp;<!--
        	--><a href="goods.php">1</a>&nbsp;|&nbsp;<!--
            --><a href="goods_2.php">2</a>&nbsp;|&nbsp;<!--
            -->3&nbsp;|&nbsp;<!--
            --><a href="goods.php">最初のページへ</a></p>
  </div>
  </div>
</div><!--Contents終了-->
