...
<link href="css/store_f.css" rel="stylesheet" type="text/css" media="screen" />
<!-- InstanceEndEditable -->
...
<div id="contents">
    ...
    <div id="sNavi">
  		<ul>
    		<li id="sd"><a href="store_d.php">ドリンク</a></li>
    		<li id="sf"><a href="#">フード</a>	  </li>
	  </ul>
    </div>
    <div id="gBack">
	  <div class="mealbox">
			<div class="meal">
			<h4><img src="images/sTitle_m.gif" width="305" height="27" alt="Meal" /></h4>
				<p class="textT">サンドウィッチ&nbsp;Sandwiches<br />
								 <span>\240</span></p>
				<p>ホットドッグ&nbsp;Hotdog<br />
					<span>\280</span></p>
				<p class="textB">トースト&nbsp;Toast<br />
								 <span>\200</span></p>
			</div>
  			<p class="sImage03"><img src="images/store_m1.jpg" width="260" height="280" alt="軽食image" /></p>
		</div>
        <div class="dessertbox">
  			<div class="dessert">
    		<h4><img src="images/sTitle_d.gif" width="305" height="27" alt="Dessert" /></h4>
    			<p class="textT">アイスシュークリーム&nbsp;IceCreampuff<br />
    						     <span>\420</span></p>
    			<p>アイスクレープ&nbsp;IceCrepe<br />
    			   <span>\450</span></p>
    			<p>ショートケーキ&nbsp;Shortcake<br />
    			   <span>\330</span></p>
   				<p>チーズケーキ&nbsp;Cheesecake<br />
    			   <span>\360</span></p>
  			</div>
          	<p class="sImage04"><img src="images/store_de1.jpg" width="260" height="280" alt="デザートimage" /></p>
        </div>
    </div>
</div>
<!--Contents終了-->
