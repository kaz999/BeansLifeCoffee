...
<!-- InstanceEndEditable -->
<!-- InstanceParam name="id" type="text" value="access_page" -->
</head>

<body id="access_page" onload="MM_preloadImages('images/cart_b_ov.gif','images/new_uesr_b_ov.gif','images/c_image1ov.jpg','images/c_image2ov.jpg','images/c_image3ov.jpg','images/c_image4ov.jpg',,'images/image_1ov.jpg','images/image_2ov.jpg','images/image_3ov.jpg')">
<!--Container開始-->
<div id="container">
<!--Header開始-->
<div id="header">
...
<!--Contents開始-->
<div id="contents">
<h3><img src="images/accessmap.gif" width="610" height="200" alt="アクセスマップAccessMap" /></h3>
<div id="gBack">
  <p class="map"><img src="images/map.gif" alt="マップ" width="290" height="290" /></p>
  <div class="Atext">
  	<h4>BeansLifeCafe&nbsp;本店</h4>
    <p><span>住所:</span>大阪府大阪市北区中津３丁目6－28</p>
    <p><span>TEL:</span>02-654-789</p>
    <p><span>FAX:</span>02-654-888    </p>
    <p><span>営業時間:</span>10:00～20:00</p>
    <p><span>定休日:</span>土日祝</p>
    <p class="text_1">阪急中津駅から徒歩10分</p>
    <h4>BeansLifeCoffee&nbsp;ネット販売</h4>
    <p><span>TEL:</span>02-654-788</p>
    <p><span>FAX:</span>02-654-889</p>
    <p><span>MAIL:</span>beanslifecoffee.com</p>
    <p><span>注文:</span>24時間受付<br />
      ※平日22時以降または土日祝日の注文は<br />
      翌日の10時から順次対応となりますので<br />
      予めご了承ください。</p>
  </div>
</div>
</div>
