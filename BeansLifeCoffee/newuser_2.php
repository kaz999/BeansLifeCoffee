...
<div id="contents">
  <div id="gBack_2">
  <h3 class="md">確認画面</h3>
  <p class="tx">この内容でお間違えなければ、会員登録ボタンを押してください。</p>
	<form action="http://connect-ki.noor.jp/BeansLifeCoffee/sitework/newuser_complete.php?<?php echo SID; ?>" method="post">
    <table width="550" border="1">
      <tr>
        <th scope="row">お名前</th>
        <td>
        	姓:<?php echo htmlspecialchars($sei,ENT_QUOTES,'UTF-8'); ?>
        	名:<?php echo htmlspecialchars($mei,ENT_QUOTES,'UTF-8'); ?>
        </td>
        </tr>
      <tr>
        <th scope="row">お名前(カナ)</th>
        <td>
        	セイ:<?php echo htmlspecialchars($seikana,ENT_QUOTES,'UTF-8'); ?>
        	メイ:<?php echo htmlspecialchars($meikana,ENT_QUOTES,'UTF-8'); ?>
        </td>
        </tr>
      <tr>
        <th scope="row">郵便番号</th>
        <td>
        	<?php echo htmlspecialchars($zipcode1,ENT_QUOTES,'UTF-8'); ?>-
            <?php echo htmlspecialchars($zipcode2,ENT_QUOTES,'UTF-8'); ?>
        </td>
        </tr>
      <tr>
    ...
    <div class="btnArea">
  	  <p><a href="newuser.php?input=1<?php echo SID; ?>"><img src="images/modoru2.gif" width="130" height="30" alt="戻る" /></a></p>
      <p><input type="image" name="newuser" id="newuser" src="images/newuser.gif" /></p>
    </div>
	</form>
	</div>
</div>
